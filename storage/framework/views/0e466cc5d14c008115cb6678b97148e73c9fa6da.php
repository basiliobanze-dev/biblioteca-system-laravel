...
<html lang="pt">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/request.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('css/loans.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('css/loans-create.css')); ?>">
